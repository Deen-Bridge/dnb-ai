...
_VERSE_DATA: list[dict[str, Any]] = [
    ...
    {"id": "lookup-001", "category": "exact_lookup", "surah": 1, "ayah": 1,
     "arabic": "بِسْمِ ٱللَّهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ",
     "english": "In the name of Allah, the Entirely Merciful, the Especially Merciful.",
     "tags": ["basmala", "opening", "fatiha"],
     "related_verses": [], "partial_quote": "", "wrong_options": []},
    {"id": "lookup-002", "category": "exact_lookup", "surah": 2, "ayah": 255,
     ...
     "related_verses": ["20:148", "3:2"], "partial_quote": "Allah – there is no deity except Him",
     "wrong_options": ["Allah – there is no god but Him, the Living, the Eternal."]},
    {"id": "lookup-003", "category": "exact_lookup", "surah": 112, "ayah": 1,
     "arabic": "قُلْ هُوَ ٱللَّهُ أَحَدٌ",
     "english": "Say, \"He is Allah, [who is] One.\"",
     "tags": ["ikhlas", "tawhid", "monotheism"],
     "related_verses": ["112:2", "112:3", "112:4"], "partial_quote": "He is Allah, One",
     "wrong_options": ["Say: He is Allah, the Unique."]},
    {"id": "lookup-004", "category": "exact_lookup", "surah": 55, "ayah": 1,
     "arabic": "ٱلرَّحْمَٰنُ",
     "english": "The Most Merciful",
     "tags": ["rahman", "mercy"],
     "related_verses": ["1:1"], "partial_quote": "Most Merciful", "wrong_options": []},
    {"id": "lookup-005", "category": "exact_lookup", "surah": 93, "ayah": 1,
     "arabic": "وَٱلضُّحَىٰ",
     "english": "By the morning hours",
     "tags": ["duha", "morning"],
     "related_verses": ["93:2"], "partial_quote": "morning hours", "wrong_options": []},
    {"id": "lookup-006", "category": "exact_lookup", "surah": 94, "ayah": 5,
     "arabic": "فَإِنَّ مَعَ ٱلْعُسْرِ يُسْرًا",
     "english": "For indeed, with hardship [will be] ease.",
     "tags": ["hardship", "ease", "relief"],
     "related_verses": ["94:6"], "partial_quote": "with hardship will be ease",
     "wrong_options": ["Verily, with hardship comes relief."]},
    {"id": "lookup-007", "category": "exact_lookup", "surah": 29, "ayah": 69,
     ...
     "related_verses": [], "partial_quote": "We will surely guide them",
     "wrong_options": ["And those who strive in Us, We surely guide them to Our paths."]},
    {"id": "lookup-008", "category": "exact_lookup", "surah": 24, "ayah": 35,
     ...
     "related_verses": [], "partial_quote": "Light of the heavens and the earth",
     "wrong_options": ["Allah is the Light of the heavens and the earth."]},
    {"id": "lookup-009", "category": "exact_lookup", "surah": 30, "ayah": 21,
     ...
     "related_verses": [], "partial_quote": "He created for you from yourselves mates",
     "wrong_options": ["And among His signs is that He created for you mates from among yourselves."]},
    {"id": "lookup-010", "category": "exact_lookup", "surah": 109, "ayah": 6,
     ...
     "related_verses": [], "partial_quote": "For you is your religion",
     "wrong_options": ["To you your religion, and to me mine."]},

    # --- Category: translation_fidelity (exact phrasing tests) ---
    {"id": "trans-001", "category": "translation_fidelity", "surah": 2, "ayah": 286,
    ...
    {"id": "trans-002", "category": "translation_fidelity", "surah": 3, "ayah": 185,
     "arabic": "كُلُّ نَفْسٍ ذَآئِقَةُ ٱلْمَوْتِ",
     "english": "Every soul will taste death.",
     "tags": ["death", "mortality", "paradise"],
     "related_verses": [], "partial_quote": "", "wrong_options": [
         "Every soul shall taste death.", "Every person will taste death.",
     ]},
    {"id": "trans-003", "category": "translation_fidelity", "surah": 4, "ayah": 135,
    ...
    {"id": "trans-004", "category": "translation_fidelity", "surah": 5, "ayah": 32,
    ...
    {"id": "trans-005", "category": "translation_fidelity", "surah": 17, "ayah": 23,
    ...
    {"id": "partial-001", "category": "partial_match", "surah": 2, "ayah": 255,
     "arabic": "ٱللَّهُ لَآ إِلَٰهَ إِلَّا هُوَ ٱلْحَىُّ ٱلْقَيُّومُ",
     "english": "Allah – there is no deity except Him, the Ever-Living, the Sustainer of [all] existence.",
     "tags": ["ayat_kursi"], "partial_quote": "Ever-Living Sustainer",
     "related_verses": [], "wrong_options": []},
    {"id": "partial-002", "category": "partial_match", "surah": 2, "ayah": 216,
     ...
     "related_verses": [], "wrong_options": []},
    {"id": "partial-003", "category": "partial_match", "surah": 94, "ayah": 5,
     "arabic": "فَإِنَّ مَعَ ٱلْعُسْرِ يُسْرًا",
     "english": "For indeed, with hardship [will be] ease.",
     "tags": ["hardship", "ease"],
     "partial_quote": "with hardship ease",
     "related_verses": [], "wrong_options": []},
    {"id": "partial-004", "category": "partial_match", "surah": 18, "ayah": 110,
     ...
     "related_verses": [], "wrong_options": []},
    {"id": "partial-005", "category": "partial_match", "surah": 103, "ayah": 1,
     "arabic": "وَٱلْعَصْرِ",
     "english": "By time",
     "tags": ["asr", "time"],
    ...
    {"id": "xref-001", "category": "cross_reference", "surah": 2, "ayah": 255,
     "arabic": "", "english": "Ayat al-Kursi (Throne Verse) – Tawhid",
     "tags": ["ayat_kursi", "tawhid"],
     "partial_quote": "", "wrong_options": [],
     "related_verses": ["3:2", "4:171", "20:14", "22:77"]},
    {"id": "xref-002", "category": "cross_reference", "surah": 112, "ayah": 1,
     "arabic": "", "english": "Surah al-Ikhlas – Pure Monotheism",
     "tags": ["ikhlas", "tawhid"],
     "partial_quote": "", "wrong_options": [],
     "related_verses": ["112:2", "112:3", "112:4", "2:165"]},
    {"id": "xref-003", "category": "cross_reference", "surah": 2, "ayah": 219,
     "arabic": "", "english": "Alcohol prohibition – staged revelation",
     "tags": ["khamr", "tadarruj"],
     "partial_quote": "", "wrong_options": [],
     "related_verses": ["4:43", "5:90", "5:91"]},
    {"id": "xref-004", "category": "cross_reference", "surah": 93, "ayah": 1,
     "arabic": "", "english": "Surah Ad-Duha – comfort after hardship",
     "tags": ["duha", "consolation"],
     "partial_quote": "", "wrong_options": [],
     "related_verses": ["93:2", "93:3", "94:5", "94:6"]},
    {"id": "xref-005", "category": "cross_reference", "surah": 2, "ayah": 185,
     "arabic": "", "english": "Fasting in Ramadan – legislation",
     "tags": ["ramadan", "fasting"],
     "partial_quote": "", "wrong_options": [],
     "related_verses": ["2:183", "2:184", "2:186"]},

    # --- Category: edge_case (similar verses, oft-quoted, partial quotes) ---
    {"id": "edge-001", "category": "edge_case", "surah": 2, "ayah": 255,
     "arabic": "", "english": "Ayat al-Kursi – most-recited verse, frequently misattributed",
     "tags": ["ayat_kursi", "misattribution"],
     "partial_quote": "The greatest verse in the Quran",
     "related_verses": [], "wrong_options": [
         "Surah al-Fatihah is the greatest verse.",
     ]},
    {"id": "edge-002", "category": "edge_case", "surah": 1, "ayah": 1,
     "arabic": "", "english": "Al-Fatihah – 'Umm al-Kitab', recited in every rak'ah",
     "tags": ["fatiha", "umm_al_kitab"],
     "partial_quote": "recited in every unit of prayer",
     "related_verses": [], "wrong_options": []},
    {"id": "edge-003", "category": "edge_case", "surah": 2, "ayah": 286,
     "arabic": "", "english": "Allah does not charge a soul beyond its capacity – often misquoted",
     "tags": ["capacity", "misquote"],
     "partial_quote": "God will not burden a soul more than it can bear",
     "related_verses": [], "wrong_options": []},
    {"id": "edge-004", "category": "edge_case", "surah": 109, "ayah": 6,
     "arabic": "", "english": "For you is your religion – misused for relativism",
     "tags": ["tolerance", "misuse"],
     "partial_quote": "To you your religion to me mine",
     "related_verses": [], "wrong_options": []},
    {"id": "edge-005", "category": "edge_case", "surah": 33, "ayah": 40,
     "arabic": "", "english": "Seal of the Prophets – finality of prophethood",
     "tags": ["khatam", "prophethood"],
     "partial_quote": "Seal of the Prophets",
     "related_verses": [], "wrong_options": []},

    # --- Additional exact lookup covering more surahs ---
    {"id": "lookup-011", "category": "exact_lookup", "surah": 108, "ayah": 1,
     "arabic": "إِنَّآ أَعْطَيْنَٰكَ ٱلْكَوْثَرَ",
     "english": "Indeed, We have granted you, [O Muhammad], al-Kawthar.",
     "tags": ["kawthar", "abundance"],
     "related_verses": [], "partial_quote": "granted you al-Kawthar",
     "wrong_options": ["Verily, We have given you the abundance."]},
    {"id": "lookup-012", "category": "exact_lookup", "surah": 110, "ayah": 1,
     ...
     "related_verses": [], "partial_quote": "victory of Allah",
     "wrong_options": ["When comes the help of Allah and the triumph."]},
    {"id": "lookup-013", "category": "exact_lookup", "surah": 78, "ayah": 1,
     "arabic": "عَمَّ يَتَسَآءَلُونَ",
     "english": "About what are they asking one another?",
     "tags": ["gathering", "questioning"],
     "related_verses": [], "partial_quote": "asking one another",
     "wrong_options": []},
    {"id": "lookup-014", "category": "exact_lookup", "surah": 97, "ayah": 1,
     ...
     "partial_quote": "Night of Decree", "wrong_options": []},
    {"id": "lookup-015", "category": "exact_lookup", "surah": 103, "ayah": 1,
     "arabic": "وَٱلْعَصْرِ",
     "english": "By time",
     "tags": ["asr", "time", "oath"],
     "related_verses": ["103:2", "103:3"],
     "partial_quote": "By time", "wrong_options": []},
    {"id": "lookup-016", "category": "exact_lookup", "surah": 104, "ayah": 1,
     "arabic": "وَيْلٌ لِّكُلِّ هَمَزَةٍ لَّمَزَةٍ",
     "english": "Woe to every scorner-mocker.",
     "tags": ["humazah", "mockery"],
     "related_verses": [], "partial_quote": "scorner-mocker",
     "wrong_options": []},
    {"id": "lookup-017", "category": "exact_lookup", "surah": 111, "ayah": 1,
     ...
     "related_verses": [], "partial_quote": "Abu Lahab",
     "wrong_options": []},
    {"id": "lookup-018", "category": "exact_lookup", "surah": 68, "ayah": 1,
     "arabic": "ن وَٱلْقَلَمِ وَمَا يَسْطُرُونَ",
     "english": "Nun. By the pen and what they inscribe.",
     "tags": ["nun", "pen", "writing"],
     "related_verses": [], "partial_quote": "By the pen", "wrong_options": []},
    {"id": "lookup-019", "category": "exact_lookup", "surah": 87, "ayah": 1,
     "arabic": "سَبِّحِ ٱسْمَ رَبِّكَ ٱلْأَعْلَىٰ",
     "english": "Exalt the name of your Lord, the Most High.",
     "tags": ["ala", "exaltation"],
     "related_verses": [], "partial_quote": "name of your Lord, the Most High",
     "wrong_options": []},
    {"id": "lookup-020", "category": "exact_lookup", "surah": 95, "ayah": 1,
     "arabic": "وَٱلتِّينِ وَٱلزَّيْتُونِ",
     "english": "By the fig and the olive.",
     "tags": ["tin", "fig", "olive"],
     "related_verses": ["95:2"], "partial_quote": "fig and the olive",
     "wrong_options": []},
]
    ...
    *,
    ...
    for case in data:
        ...
        if cat == "exact_lookup":
            ...
            ref_valid = all(
                reference_valid(int(r.split(":")[0]), int(r.split(":")[1]))
                for r in related
            )
        ...
        if verbose:
            ...
            print(f"  [{status}] {case['id']:<14} {cat:<22} "
