...
from tool_reliability import router as tool_reliability_router
...
# Tool-use reliability: selection, validation, retries, traces, and metrics
app.include_router(tool_reliability_router)
