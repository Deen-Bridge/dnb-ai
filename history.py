"""Historical context injection â€” asbab al-nuzul, hadith circumstances,
...
does not generate history with a language model â€” every entry is a fixed record
...
ASBAB_AL_NUZUL: dict[str, dict[str, str]] = {
    ...
    "4:43": {
        "summary": (
            "The second stage on intoxicants â€” forbidding approaching prayer "
            "while intoxicated â€” revealed after a Companion led prayer and "
    ...
    "2:256": {
        "summary": (
            "'There is no compulsion in religion' â€” reported to have been "
    ...
    "80:1": {
        "summary": (
            "'He frowned and turned away' â€” revealed when the Prophet turned "
...
HADITH_CONTEXTS: dict[str, dict[str, str]] = {
    "actions-by-intentions": {
        ...
        "circumstance": (
            ...
            "rather than for faith â€” 'the emigrant to what he emigrated for'. "
    ...
    "standing-for-funeral": {
        ...
        "circumstance": (
            ...
            "soul?' â€” narrated to show the ruling's rationale ('illa) and how "
...
FIQH_TIMELINE: dict[str, dict[str, Any]] = {
    "intoxicants": {
        ...
        "stages": [
            ...
            {
                "period": "2:219",
                "development": "Named as containing great sin outweighing benefit â€” a moral warning.",
            },
            {
                "period": "4:43",
                "development": "Approaching prayer while intoxicated forbidden â€” a partial, timed restriction.",
            },
            {
                "period": "5:90â€“91",
    ...
    "riba": {
        ...
        "scope": "universal",
        "stages": [
            {"period": "Revelation", "development": "Progressive condemnation culminating in 2:275â€“279."},
            {
...
def _render_block(ctx: HistoricalContext) -> str:
    ...
    if ctx.hadith_contexts:
        ...
        lines += [f"- {e.text} â€” {e.circumstance} [{e.attribution}]" for e in ctx.hadith_contexts]
    if ctx.timelines:
